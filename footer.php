				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<ul class="m-b-70">
						<li class="txt14 m-b-14">
							<i class="fa fa-coffee fs-16 dis-inline-block size19" aria-hidden="true"></i>
                                                        <a href="about.php">Quem Somos</a>
						</li>

						<li class="txt14 m-b-14">
							<i class="fa fa-archive fs-16 dis-inline-block size19" aria-hidden="true"></i>
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					<h4 class="txt13 m-b-33">
						...
						<li class="txt14 m-b-14">
							...
							61- 9 99937 2601 <br>
							e-mail: <a href="jwilson@3sw.com.br">jwilson@3sw.com.br</a>
						</li>
						<li class="txt14 m-b-14">
							<i class="fa fa-whatsapp fs-16 dis-inline-block size19" aria-hidden="true"></i>
							61- 9 99238 9546 <br>
